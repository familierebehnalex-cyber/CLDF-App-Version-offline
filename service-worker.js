...
const CACHE = 'cldf-offline-v4-7-10-audio-fingerprints';
const APP_SHELL = [
  './',
  './index.html',
  './404.html',
  './manifest.webmanifest',
  './assets/styles.css?v=4.7.10',
  './assets/app.js?v=4.7.10',
  ...
  './assets/radio-live-api.js?v=4.7.10',
  './assets/getinline-data.js',
  './assets/step-sheet-patterns.js?v=4.7.10',
  './assets/video-movement-references.js?v=4.7.10',
  './assets/basic-step-library.js?v=4.7.10',
  './data/video-movement-references-index.json',
  './data/video-movement-references-pack-001.json',
  './data/video-movement-references-pack-002.json',
  './data/basic-step-library-index.json',
  './assets/video-motion.js?v=4.7.10',
  './assets/mediapipe/pose/pose.js?v=4.7.10',
