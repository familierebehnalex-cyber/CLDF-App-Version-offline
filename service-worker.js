...
const CACHE = 'cldf-offline-v4-7-6-fingerprints';
const APP_SHELL = [
  './',
  './index.html',
  './404.html',
  './manifest.webmanifest',
  './assets/styles.css?v=4.7.6',
  './assets/app.js?v=4.7.6',
  './assets/local-store.js',
  './assets/audio-engine.js',
  './assets/audio-fingerprints.js',
  './data/audio-fingerprints-index.json',
  './data/audio-fingerprints-pack-001.json',
  './data/audio-fingerprints-pack-002.json',
  './data/audio-fingerprints-pack-003.json',
  './data/audio-fingerprints-pack-004.json',
  './data/audio-fingerprints-pack-005.json',
  './data/audio-fingerprints-pack-006.json',
  './data/audio-fingerprints-pack-007.json',
  './data/audio-fingerprints-pack-008.json',
  './assets/data.js',
  ...
  './assets/radio-live-api.js?v=4.7.6',
  './assets/getinline-data.js',
  './assets/step-sheet-patterns.js?v=4.7.6',
  './assets/video-motion.js?v=4.7.6',
  './assets/mediapipe/pose/pose.js?v=4.7.6',
