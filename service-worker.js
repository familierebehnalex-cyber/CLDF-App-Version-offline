...
const APP_SHELL = [
  ...
  './assets/styles.css?v=4.5.8',
  './assets/app.js?v=4.5.8',
  ...
  './assets/step-sheet-patterns.js?v=4.5.8',
  './assets/video-motion.js?v=4.5.8',
  './assets/mediapipe/pose/pose.js?v=4.5.8',
