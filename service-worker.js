...
const APP_SHELL = [
  ...
  './assets/styles.css?v=4.5.6',
  './assets/app.js?v=4.5.6',
  ...
  './assets/step-sheet-patterns.js?v=4.5.6',
  './assets/video-motion.js?v=4.5.6',
  './assets/mediapipe/pose/pose.js?v=4.5.6',
