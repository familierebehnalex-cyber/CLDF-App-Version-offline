...
const CACHE = 'cldf-offline-v4-7-9-movement-references';
const APP_SHELL = [
  './',
  './index.html',
  './404.html',
  './manifest.webmanifest',
  './assets/styles.css?v=4.7.9',
  './assets/app.js?v=4.7.9',
  ...
  './assets/radio-live-api.js?v=4.7.9',
  './assets/getinline-data.js',
  './assets/step-sheet-patterns.js?v=4.7.9',
  './assets/video-movement-references.js?v=4.7.9',
  './assets/basic-step-library.js?v=4.7.9',
  ...
  './assets/video-motion.js?v=4.7.9',
  './assets/mediapipe/pose/pose.js?v=4.7.9',
