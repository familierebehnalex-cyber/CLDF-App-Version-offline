...
const APP_SHELL = [
  ...
  './assets/styles.css?v=4.5.7',
  './assets/app.js?v=4.5.7',
  ...
  './assets/step-sheet-patterns.js?v=4.5.7',
  './assets/video-motion.js?v=4.5.7',
  './assets/mediapipe/pose/pose.js?v=4.5.7',
