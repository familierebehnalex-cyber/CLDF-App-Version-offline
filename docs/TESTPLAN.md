# Testplan CLDF Offline-App v4.7.8

## Start, Version und Offline

1. `STARTEN-AM-PC.bat` starten.
2. Startseite, ursprüngliche Grafik, Navigation und sichtbare Version 4.7.8 prüfen.
...
3. Prüfen, dass 3.480 eingebaute Audio-Referenzen angezeigt werden und keine Benutzerdatei verlangt wird.
